const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'TotalGPT account',
    langGeniusAccountTip: 'Your TotalGPT account and associated user data.',
    editName: 'Edit Name',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by TotalGPT allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  about: {
    ...
    nowAvailable: 'TotalGPT {{version}} is now available.',
    latestAvailable: 'TotalGPT {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
