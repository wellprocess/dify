const translation = {
  ...
  welcome: 'Welcome to TotalGPT, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting TotalGPT Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on TotalGPT',
  invalid: 'The link has expired',
  explore: 'Explore TotalGPT',
